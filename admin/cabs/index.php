        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped table-hover">
				...
				<tbody>
					...
					$i = 1;
						// Corrected SQL query
						$qry = $conn->query("SELECT c.*, cc.type as category FROM `cab_list` c INNER JOIN `category_list` cc ON c.category_id = cc.id WHERE c.delete_flag = 0 ORDER BY c.`reg_code` ASC");
